    ...
    <div id="wrap">
		<div id="container">
			...
			<div id="contents" class="clearfix">
				<div id="review_box">
                    <p>
                        “내 삶에서 불가피하게 직면해야 했던 시기가 있습니다. 바로 1958년의 여름, 나의 열일곱 살 무렵 말입니다.
						나는 그 시기를 사회·역사적으로 그려 내기를 바랐고, 이를테면 오토픽션의 방법으로 『그들의 말 혹은 침묵』을 썼습니다.”
						-아니 에르노 “내 삶에서 불가피하게 직면해야 “내 삶에서 불가피하게 직면해야 “내 삶에서 불가피하게 직면해야 “내 삶에서 
                    </p>
				</div>
			</div>
            <p id="limit-text" >
